...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_LIGHT_BLUE = SET_TEXT_COLOR + "75m";
    public static final String SET_TEXT_COLOR_PURPLE = SET_TEXT_COLOR + "18m";
    public static final String SET_TEXT_COLOR_MAGENTA = SET_TEXT_COLOR + "5m";
    public static final String SET_TEXT_COLOR_CORAL = SET_TEXT_COLOR + "210m";
    ...
    public static final String WHITE_KING_GLYPH = " ♔ ";
    public static final String WHITE_QUEEN_GLYPH = " ♕ ";
    public static final String WHITE_BISHOP_GLYPH = " ♗ ";
    public static final String WHITE_KNIGHT_GLYPH = " ♘ ";
    public static final String WHITE_ROOK_GLYPH = " ♖ ";
    public static final String WHITE_PAWN_GLYPH = " ♙ ";
    public static final String BLACK_KING_GLYPH = " ♚ ";
    public static final String BLACK_QUEEN_GLYPH = " ♛ ";
    public static final String BLACK_BISHOP_GLYPH = " ♝ ";
    public static final String BLACK_KNIGHT_GLYPH = " ♞ ";
